...
This project implements an end-to-end computer vision pipeline capable of detecting and tracking objects in real time from both video files and live camera feeds. The system emphasizes performance, modularity, and scalability for real-world applications.
